...
<body class="pixel-cursor">
    ...
    <script>
        ...
        document.querySelectorAll('.menu-title, button').forEach(element => {
        ...
        function loadEmulators() {
            ...
            EJS_gameUrl = "https://j05e102030.github.io//blob/main/sonic2.md";
            var script = document.createElement('script');
            script.src = "https://cdn.emulatorjs.org/stable/data/loader.js";
            document.head.appendChild(script);
            
            // Emulador de Super Metroid
            setTimeout(function() {
                EJS_player = "#metroid-game";
                EJS_core = "snes";
                EJS_pathtodata = "https://cdn.emulatorjs.org/stable/data/";
                // Ruta final corregida para GitHub Pages con usuario J05E102030 y repositorio Mi-blog-personal
                EJS_gameUrl = "https://j05e102030.github.io//blob/main/supermetroid.sfc";
        ...
        // Cargar emuladores cuando se abre la sección de juegos
        document.querySelectorAll('.menu-title').forEach(title => {
            title.addEventListener('click', () => {
                if (title.textContent === '¡Juega Aquí!' && !title.classList.contains('emulators-loaded')) {
                    setTimeout(loadEmulators, 500);
                    title.classList.add('emulators-loaded');
                }
            });
        });
